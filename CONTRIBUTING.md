...
If you encounter any issues or have ideas for improvements, please create an issue on the [GitHub issue tracker](https://github.com/omega-mvc/application/issues).
...
composer phpstan  # PHPStan level 10 static analysis over src/ and tests/

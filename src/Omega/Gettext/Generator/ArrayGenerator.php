...
final class ArrayGenerator extends AbstractGenerator
{
     ...
     * @return string PHP code string
      * @param array<array-key, mixed> $array Structure to render.
      * @return string Pretty-printed PHP code ending with a semicolon.
     */
     ...
     * @return string Pretty-printed PHP code
      * @param array<array-key, mixed> $array Structure to render.
      * @param int $depth Current nesting level used for indentation.
     ...
     * @return bool True if the array is a list, false otherwise
      * @param array<array-key, mixed> $value Array to check.
      * @return bool True when the keys are the sequence 0..count-1.
     */

 ...
 * Class MoGenerator
 *
 * Generates binary .mo files from gettext translations.
 *
 * This final class extends `AbstractGenerator` and implements `generateString()`
 * to produce a machine-readable .mo file. It can optionally include headers
 * from the translations.
 */
final class MoGenerator extends AbstractGenerator
{
    /** @var bool Whether to include the headers in the generated .mo file */
    private bool $includeHeaders = false;

    /**
     * Enable or disable inclusion of headers in the generated .mo file.
     *
     * @param bool $includeHeaders Defaults to true; if true, headers are included
    ...
    /**
     * Determines whether a translation contains plural translations.
     *
     * @param Translation $translation The translation to check
     * @return bool True if the translation has plural forms, false otherwise
      * @param Translation $translation Entry to inspect.
      * @return bool True when at least one plural form has a non-empty translation.
     */

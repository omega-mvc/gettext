...
final class PoGenerator extends AbstractGenerator
{
     ...
     * @return void
      * @param array<int, string> $lines Accumulator updated by reference.
      * @param string $prefix Prefix for the line, e.g. "#~ " for disabled entries.
      * @param string $name PO directive name, e.g. msgid or msgstr[2].
      * @param string $value Text to encode and append.
     */
     ...
     * @return string The encoded string ready for use in a .po file
      ...
      * @return string The value wrapped in double quotes and escaped.
     */

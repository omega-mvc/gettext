...
final class StrictPoLoader extends Loader
{
     ...
     * Attempts to read the exact informed string
      * @param string $data Exact string expected at the current position.
      * @return bool True (and advances the cursor) on match.
     */
     ...
     * Attempts to read the exact informed char
      * @param string $char Single character expected at the current position.
      * @return bool True (and advances the cursor) on match.
     */
     ...
     * Read sequential characters that match the given character set until the length range is satisfied
      ...
      * @param int $min Minimum number of characters required.
      * @param int $max Maximum number of characters consumed.
      * @param string $name Human readable charset name used in error messages.
      * @return string The consumed substring.
      * @throws \Exception If fewer than $min characters are found.
     */
     ...
     * Attempts to read a quoted string while parsing escape sequences prefixed by \
      * @param string|null $context Identifier being parsed, used to restore the cursor on failure.
      * @return string The decoded text content.
      * @throws \Exception On unterminated or malformed strings.
     */
     ...
     * Attempts to read an identifier
      * @param string $identifier Keyword to match, e.g. msgid.
      * @param bool $throwIfNotFound Throw instead of returning null when missing.
      * @return string|null The decoded quoted value following the keyword.
      * @throws \Exception If not found and $throwIfNotFound is true.
     */
     ...
     * Attempts to read the pluralized translation
      * @param bool $throwIfNotFound Throw instead of returning false when missing.
      * @return bool True when an indexed msgstr was consumed.
      * @throws \Exception If not found and $throwIfNotFound is true.
     */
     ...
     * @return array<string, string>
      * @param string $data Decoded header block.
    ...
    /**
     * Adds a warning
      * @param string $message Warning description including its source position.
      * @throws \Exception If throwOnWarning is enabled.
     */
